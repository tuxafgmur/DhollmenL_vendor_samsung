...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/p31xx/common/system/bin/gpsd:system/bin/gpsd \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/p31xx/common/system/etc/wifi/bcmdhd_apsta.bin:system/etc/wifi/bcmdhd_apsta.bin \
    $(LOCAL_PATH)/p31xx/common/system/etc/wifi/bcmdhd_mfg.bin:system/etc/wifi/bcmdhd_mfg.bin \
    $(LOCAL_PATH)/p31xx/common/system/etc/wifi/bcmdhd_sta.bin:system/etc/wifi/bcmdhd_sta.bin \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/p31xx/common/system/lib/hw/camera.vendor.piranha.so:system/lib/hw/camera.vendor.piranha.so \
    $(LOCAL_PATH)/p31xx/common/system/lib/hw/gps.omap4.so:system/lib/hw/gps.omap4.so
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/tab2-common/system/vendor/lib/libWVStreamControlAPI_L1.so:system/vendor/lib/libWVStreamControlAPI_L1.so \
    $(LOCAL_PATH)/tab2-common/system/vendor/lib/libwvdrm_L1.so:system/vendor/lib/libwvdrm_L1.so \
